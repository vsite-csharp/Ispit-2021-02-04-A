...
namespace Vsite.CSharp.Ispit.Zadatak2
{
    class Program
    {
        //  Napisati metodu KlasificirajBrojeve koja kao argument dobiva kolekciju cijelih brojeva IEnumerable<int>.
        ...
        public static void KlasificirajBrojeve(int[] nizBrojeva) 
        {
            
            foreach (int inter in nizBrojeva)
            {
                if (inter > 0)
                {
        ...
        public static void KlasificirajBrojeve( List<int> listaBrojeva)
        {
            foreach (int inter in listaBrojeva)
            {
                if (inter > 0)
                {
